...
My main interests lie in hardware-related development, particularly in the integration of microcontrollers, 3D printing, and CAD. You can read more about my current UAV project on my blog.
I'm also in the process of starting a small business that sells custom software for inventory management, 3D animations, and custom websites.
...
### 💻 Tech Stack
- **C#** with .NET10
- **C++** with Qt and OpenCV
- **2D and 3D Art** with Blender and Adobe Substance Painter
- **Microcontroller development** with Arduino, Ardupilot and RaspberryPi
- Backend and Frontend developent with Astro, HTML, CSS, Javascript, PHP, SQLite and ChartJS
